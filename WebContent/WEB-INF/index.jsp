...
<section >
	<nav  style=" background-color: #5a471b;position: fixed;width: 100%; 
  z-index: 1000;" class="navbar navbar-expand-lg navbar-dark bg-primary">
...
<form class="d-flex"  action="abmcProductos" method="get">
        ...
        <input type="hidden" class="form-control" id="accion" name="accion" value="buscarIndex" >
        <button class="btn btn-light" type="submit" value="buscarIndex">Buscar</button>
      </form>
			</div>
		</div>
	</nav>
...
<!-- 
	...
	<section >
		...
		<div class="row" >
			<div class="col-2">
				<ul style="margin-top: 5mm; margin-left:5mm; margin-bottom: 10mm; box-shadow: 2px 2px 2px 2px #BBB0B0 " class="list-group">
				...
				<div class="row">
					...
					<div class="col-4">
						<div class="card" style="width: 18rem;"
							...
							<!--	<img src="<%=request.getContextPath()%>/MostrarFotoServlet?id=<%=Prod.getIdProducto() %>" class="card-img"> 
							-->
							...
							<div class="card-body">
								...
								<a
									href="abmcLdp?accion=AgregarCarrito&id=<%=Prod.getIdProducto()%>"
