...
<body>
 ...
 %>
	...
	<br>
	<h3 style="margin-left: 140mm">PRODUCTOS</h3>
	<br>
  ...
  <path
			...
			<div class="col-3" style="margin-right: 10px; margin-left: 70mm">
				<input type="hidden" class="form-control" id="accion" name="accion"
					value="buscar"> <input type="text" value="<%=buscar%>"
					class="form-control" id="buscar" name="buscar" placeholder="buscar"
					aria-label="Search">
			</div>
			<div class="col-2">
	...
	<br>
	<div class="row">
		<div class="col-4" style="margin-left: 3mm; margin-right: -67mm">
			<form action="abmcProductos" method="get">
				<h6>filtrar por:</h6>
					<input type="hidden" class="form-control" id="accion" name="accion"
						value="filtrarStock">
					<div class="form-check">
						<input class="form-check-input" type="checkbox" name="sinStock"
							id="sinStock" > <label class="form-check-label"
							for="sinStock"> Productos sin stock </label>
							</div>
						<div class="form-check">
							<input class="form-check-input" type="checkbox" name="todos"
								id="todos"> <label class="form-check-label" for="todos">
								Todos </label>
						</div>
						<input type="submit" class="btn btn-dark"
							style="width: 30%; height: 1.7%; margin-top: 2mm" value="Aplicar filtro">
			</form>
		</div>
