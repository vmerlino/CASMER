...
<body>
 ...
 %>
  ...
  <div class="col-12">
    ...
    <input type="text" style=" box-shadow: 1px 1px 1px 1px #BBB0B0" class="form-control" id="Categoria" name="Categoria" readonly value="<%=idCategoria%>" placeholder="Ingrese IdProducto" required>
  </div>
  <div class="col-md-12">
    <label for="inputEmail4" class="form-label">Descripcion</label>
    <input type="text" class="form-control" id="Descripcion" name="Descripcion" value="<%=Descripcion%>" placeholder="Ingrese idCategoria" required>
  </div>
